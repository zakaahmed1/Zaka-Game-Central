...
export const countries: Country[] = [
  ...
  { name: ['Antigua and Barbuda', 'Antigua', 'Barbuda'], flagUrl: 'https://flagcdn.com/w320/ag.png' },
  ...
  { name: ['Côte d\'Ivoire', 'Ivory Coast'], flagUrl: 'https://flagcdn.com/w320/ci.png' },
  ...
  { name: ['Timor-Leste', 'East Timor'], flagUrl: 'https://flagcdn.com/w320/tl.png' },
