// utils/flagData.ts
export type Country = {
  name: string[]; // Multiple acceptable names
  flagUrl: string;
};

export const countries: Country[] = [
  { name: ['Aruba'], flagUrl: 'https://flagcdn.com/w320/aw.png' },
  { name: ['Afghanistan, Islamic Republic of Afghanistan'], flagUrl: 'https://flagcdn.com/w320/af.png' },
  ...
  { name: ['United Arab Emirates, UAE', 'United Emirates', 'U.A.E.', 'Emirates'], flagUrl: 'https://flagcdn.com/w320/ae.png' },
  ...
  { name: ['Antigua and Barbuda', 'Antigua & Barbuda', 'Antigua', 'Barbuda'], flagUrl: 'https://flagcdn.com/w320/ag.png' },
  ...
  { name: ['Bahamas', 'The Bahamas'], flagUrl: 'https://flagcdn.com/w320/bs.png' },
  { name: ['Bosnia and Herzegovina', 'Bosnia', 'Bosnia & Herzegovina', 'Bosnia Herzegovina'], flagUrl: 'https://flagcdn.com/w320/ba.png' },
  ...
  { name: ['Central African Republic', 'CAR'], flagUrl: 'https://flagcdn.com/w320/cf.png' },
  ...
  { name: ['Côte d\'Ivoire', 'Ivory Coast', "Cote Divoire"], flagUrl: 'https://flagcdn.com/w320/ci.png' },
  { name: ['Cameroon'], flagUrl: 'https://flagcdn.com/w320/cm.png' },
  { name: ['The Democratic Republic of the Congo', 'DR Congo', 'Democratic Republic of Congo', 'Democratic Republic of the Congo', 'The Democratic Republic of Congo' ], flagUrl: 'https://flagcdn.com/w320/cd.png' },
  { name: ['Congo', 'Republic of the Congo', 'Republic of Congo', 'Congo-Brazzaville'], flagUrl: 'https://flagcdn.com/w320/cg.png' },
  { name: ['Colombia'], flagUrl: 'https://flagcdn.com/w320/co.png' },
  { name: ['Comoros'], flagUrl: 'https://flagcdn.com/w320/km.png' },
  { name: ['Cabo Verde', 'Cape Verde'], flagUrl: 'https://flagcdn.com/w320/cv.png' },
  { name: ['Costa Rica'], flagUrl: 'https://flagcdn.com/w320/cr.png' },
  { name: ['Cuba'], flagUrl: 'https://flagcdn.com/w320/cu.png' },
  { name: ['Curaçao', 'Curacao'], flagUrl: 'https://flagcdn.com/w320/cw.png' },
  { name: ['Cyprus'], flagUrl: 'https://flagcdn.com/w320/cy.png' },
  { name: ['Czechia', 'Czech Republic'], flagUrl: 'https://flagcdn.com/w320/cz.png' },
  ...
  { name: ['Dominican Republic', 'Dominican', 'Republic Dominican'], flagUrl: 'https://flagcdn.com/w320/do.png' },
  ...
  { name: ['Spain', 'Espana'], flagUrl: 'https://flagcdn.com/w320/es.png' },
  ...
  { name: ['Falkland Islands'], flagUrl: 'https://flagcdn.com/w320/fk.png' },
  ...
  { name: ['United Kingdom', 'England', 'UK', 'Britain', 'Great Britain', 'U.K.'], flagUrl: 'https://flagcdn.com/w320/gb.png' },
  ...
  { name: ['Gambia', 'The Gambia'], flagUrl: 'https://flagcdn.com/w320/gm.png' },
  { name: ['Guinea-Bissau', 'Guinea Bissau'], flagUrl: 'https://flagcdn.com/w320/gw.png' },
  ...
  { name: ['Ireland', 'Republic of Ireland', 'ROI'], flagUrl: 'https://flagcdn.com/w320/ie.png' },
  ...
  { name: ['Kiribati', 'Kiribas'], flagUrl: 'https://flagcdn.com/w320/ki.png' },
  { name: ['Saint Kitts and Nevis', 'Saint Kitts & Nevis'], flagUrl: 'https://flagcdn.com/w320/kn.png' },
  { name: ['South Korea', 'Republic of Korea', 'Korea Republic'], flagUrl: 'https://flagcdn.com/w320/kr.png' },
  { name: ['Kuwait'], flagUrl: 'https://flagcdn.com/w320/kw.png' },
  { name: ['Laos', 'Lao'], flagUrl: 'https://flagcdn.com/w320/la.png' },
  ...
  { name: ['Saint Lucia', 'St Lucia', 'St. Luica'], flagUrl: 'https://flagcdn.com/w320/lc.png' },
  ...
  { name: ['Macao', 'Macau'], flagUrl: 'https://flagcdn.com/w320/mo.png' },
  ...
  { name: ['Netherlands', 'Holland', 'The Netherlands'], flagUrl: 'https://flagcdn.com/w320/nl.png' },
  ...
  { name: ['Philippines', 'The Philippines'], flagUrl: 'https://flagcdn.com/w320/ph.png' },
  ...
  { name: ['North Korea', 'Korea DPR'], flagUrl: 'https://flagcdn.com/w320/kp.png' },
  ...
  { name: ['Russia', 'Russian Federation'], flagUrl: 'https://flagcdn.com/w320/ru.png' },
  ...
  { name: ['Sao Tome and Principe', 'Sao Tome', 'Sao Tome Principe'], flagUrl: 'https://flagcdn.com/w320/st.png' },
  ...
  { name: ['Eswatini', 'Swaziland'], flagUrl: 'https://flagcdn.com/w320/sz.png' },
  { name: ['Seychelles', 'The Seychelles'], flagUrl: 'https://flagcdn.com/w320/sc.png' },
  ...
  { name: ['Timor-Leste', 'East Timor', 'Timor Leste'], flagUrl: 'https://flagcdn.com/w320/tl.png' },
  { name: ['Tonga'], flagUrl: 'https://flagcdn.com/w320/to.png' },
  { name: ['Trinidad and Tobago', 'Trinidad & Tobago'], flagUrl: 'https://flagcdn.com/w320/tt.png' },
  { name: ['Tunisia'], flagUrl: 'https://flagcdn.com/w320/tn.png' },
  { name: ['Turkey', 'Turkiye'], flagUrl: 'https://flagcdn.com/w320/tr.png' },
  ...
  { name: ['United States', 'US', 'USA', 'U.S.A.', 'The United States', 'The United States of America', 'United States of America'], flagUrl: 'https://flagcdn.com/w320/us.png' },
  { name: ['Uzbekistan'], flagUrl: 'https://flagcdn.com/w320/uz.png' },
  { name: ['Vatican City', 'The Vatican', 'Vatican', 'Holy See'], flagUrl: 'https://flagcdn.com/w320/va.png' },
  { name: ['Saint Vincent and the Grenadines', 'Saint Vincent', 'Saint Vincent & The Grenadines'], flagUrl: 'https://flagcdn.com/w320/vc.png' },
  { name: ['Venezuela'], flagUrl: 'https://flagcdn.com/w320/ve.png' },
  { name: ['Vietnam', 'Viet Nam'], flagUrl: 'https://flagcdn.com/w320/vn.png' },
  ...
  { name: ['South Africa', 'KSA'], flagUrl: 'https://flagcdn.com/w320/za.png' },
